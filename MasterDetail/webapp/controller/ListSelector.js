sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zgblessons.MasterDetail.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zgblessons.MasterDetail.controller.ListSelector
			 */
			 ...
			 * @return {zgblessons.MasterDetail.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
