sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zgblessons/MasterDetail/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zgblessons.MasterDetail.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zgblessons/MasterDetail/localService/mockserver"], function (mockserver) {
